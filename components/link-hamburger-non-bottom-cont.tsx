...
const LinkHamburgerNonBottomCont: NextPage<LinkHamburgerNonBottomContType> = ({
  ...
  return (
    <div className="box-border flex flex-row items-center justify-center py-[50px] px-0 text-center text-21xl text-black font-reg-medium self-stretch border-b-[1px] border-solid border-black">
